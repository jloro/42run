...
#    Updated: 2019/09/19 18:03:06 by jloro            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =  Time.cpp SdlWindow.cpp Mesh.cpp Model.cpp Shader.cpp Camera.cpp \
		...
		BoxColliderRenderer.cpp BoxCollider.cpp Room.cpp RoomManager.cpp\
...
HEADER = SdlWindow.hpp Texture.hpp Vertex.hpp Shader.hpp Mesh.hpp Time.hpp \
		...
		Obstacle.hpp BoxColliderRenderer.hpp BoxCollider.hpp Model.hpp Room.hpp\
		RoomManager.hpp \
